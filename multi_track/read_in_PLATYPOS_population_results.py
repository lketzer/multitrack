...
def read_in_PLATYPOS_results_dataframe(path_to_results, N_tracks):
    """
    Calls read_in_PLATYPOS_results & then does some more re-aranging to
    the data to make it easier to handle.
    ...
    planet_df_dict, planet_init_df, tracks_dict = read_in_PLATYPOS_results(
...
def read_in_PLATYPOS_results_dataframe_second_to_last_time(
    ...
    # with the final parameters one time step before
