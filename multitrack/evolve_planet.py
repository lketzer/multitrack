...
from multitrack.complete_track_dict import complete_track_dict
from multitrack.write_info_to_file import write_file_thermal_contraction_radius
...
def evolve_1planet_1track(folder_planet_track,
                          t_final, initial_step_size,
    ...
    if len(track_dict) == 9:
        ...
        #beta_on = "yes"
        #if beta_settings["beta_calc"] == "off":
        #    beta_on = "no"
        ...
        # set planet name based on specified track
        planet.generate_planet_id(t_final, 
                                  folder,
                                  evo_track_dict=track_dict)
    ...
    # Option 2
        ...
        # check if result exists, if not evolve planet
        path = os.path.join(path_for_saving, folder, pl_file_name)
        if not os.path.isdir(path):
            planet.evolve_forward_and_create_full_output(
                                            t_final,
                                            initial_step_size,
...
# def evolve_one_planet_HBA(pl_folder_pair,
#                           t_final, initial_step_size,
#                           evo_track_dict_list, path_for_saving,
#                           Lx1Gyr="Jackson12"):
#     """
...
#             # check if result exists, if not evolve planet
#             if not os.path.isdir(path_for_saving + pl_file_name):
#                 pl.evolve_forward_and_create_full_output_HBA(
#                     t_final,
#                     initial_step_size,
#                     evo_track_dict=track,
#                     path_for_saving=path_for_saving,
...
# def evolve_one_planet_along_one_track_HBA(folder_planet_track,
#                                           t_final, initial_step_size,
#                                           path_for_saving,
#                                           Lx1Gyr="Jackson12"):
#     """
...
#         # check if result exists, if not evolve planet
#         if not os.path.isdir(path_for_saving + pl_file_name):
#             planet.evolve_forward_and_create_full_output_HBA(
#                 t_final,
#                 initial_step_size,
#                 evo_track_dict=track_dict,
#                 path_for_saving=path_for_saving,
...
def evolve_one_planet_along_one_track(folder_planet_track,
                                      ...
                                      Lx1Gyr="Jackson12"):
    """
    OLD: used the old beta specification!
    OUTDATED!!!
    ...
    Lx1Gyr (str): see complete_track_dict.py for info!
